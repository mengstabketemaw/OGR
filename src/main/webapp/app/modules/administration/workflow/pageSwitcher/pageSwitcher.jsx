        ...
        <Card className="shadow">
          <CardHeader className="border-0">
            <div  className="row">
              ...
              <Button hidden={sequenceFromDatabase[currentPage] !== 3} disabled={sequenceFromDatabase[currentPage] !== 3}  className={ 'col-12 mr-4 mb-2 bg-translucent-light text-dark' } onClick={handleNotify}>
