...
const TechnicalReview = params => {
  ...
  const data = formatDisplayOn(getFieldValue(formData), [...formFields.filter(f => f.state.id === 0)], key);
    ...
    <>
      <Col md="8" className={'container'}>
        <div className="d-flex justify-content-between">
          ...
          <div>
            {collapse ? (
              <FontAwesomeIcon icon={faAnglesDown} onClick={() => setCollapse(!collapse)} />
            ) : (
